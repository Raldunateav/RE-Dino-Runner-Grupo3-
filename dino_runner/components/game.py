...
from dino_runner.components.death_counter import Dead

from dino_runner.utils.constants import BG, ICON, SCREEN_HEIGHT, SCREEN_WIDTH, SMALL_CACTUS, TITLE, FPS, CLOUD, FONT_STYLE, DINO_DEAD
...
class Game:
    ...
    def show_menu(self):
        ...
        if self.death_count == 0:
            ...
            font = pygame.font.Font(FONT_STYLE, 30)
            text_component = font.render("Press any key to restart the game", True, (232,85,68))
            text_rect = text_component.get_rect()
            text_rect.center = (half_screen_width , half_screen_height)
            self.screen.blit(text_component, text_rect)
